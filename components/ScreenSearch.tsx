        ...
        {items.map((item, idx) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              {/* 多彩贵州智游卡 Hidden as requested */}
              {/* {item.highlight && (
                <div className="mt-3 bg-white p-3 rounded-xl shadow-sm border border-blue-100">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold text-blue-700">多彩贵州智游卡</span>
                    <span className="text-[10px] text-gray-400">查看更多 ›</span>
                  </div>
                  <div className="flex gap-2">
                    <div className="flex-1 bg-blue-50/50 rounded p-1.5 text-center">
                      <div className="text-[10px] text-blue-600 font-bold">避暑季</div>
                      <div className="text-[8px] scale-90 text-gray-400">限时门票5折</div>
                    </div>
                    <div className="flex-1 bg-blue-50/50 rounded p-1.5 text-center">
                      <div className="text-[10px] text-blue-600 font-bold">酒店券</div>
                      <div className="text-[8px] scale-90 text-gray-400">最高减200</div>
                    </div>
                  </div>
                </div>
              )} */}
